                        ...
                        switch (op1) {
                            case 1:
                                ...
                                for (int i = 0; i < recetor.size(); i++) {
                                      if (recetor.get(i).getNome().equals(titulo))
                                          //Ver quantidade, o Daniel tem de atualizar.
                                          {
                                             System.out.println("Número de exemplares disponíveis/Número de exemplares vendidos: \n");                                    
                                             aviso=true;
                                          }
                                 }
                                if (aviso==false)System.out.println("Não existem exemplares correspondentes à sua pesquisa.\n");
                                aviso=false;
                            case 2:
                                ...
                                for (int i = 0; i < recetor.size(); i++) {
                                      if (recetor.get(i).getRealizador().equals(realizador))
                                          //Ver quantidade, o Daniel tem de atualizar.
                                          {
                    ...
                    case 3:
                        ...
                        switch (op2) {
                            case 1:
                                ...
                                if (aviso1==false)System.out.println("Não existem exemplares correspondentes à sua pesquisa.\n");
                                aviso1=false;
                            case 2:
                                System.out.println("Escreva o nome do realizador: \n");
                                String realizador=Ler.umaString();
